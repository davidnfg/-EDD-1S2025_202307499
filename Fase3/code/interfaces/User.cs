...
namespace code.interfaces
{
    public class UserWindow : Window
    {
        ...
        private void OnVerFacturasButtonClicked(object sender, EventArgs e)
        {
            ...
            // Obtener los IDs de los vehículos del usuario
            List<int> List_Ids_vehiculos = code.data.Variables.listaVehiculos.ListarVehiculos_Usuario(idUsuario);

            // Obtener los IDs de los servicios asociados a los vehículos
            List<int> Lista_Ids_Servicios = code.data.Variables.arbolServicios.Servicios_Vehiculos(List_Ids_vehiculos);

            // Obtener las facturas asociadas a los servicios
            List<code.structures.merkle.Factura> Lista_Facturas_Usuario = code.data.Variables.arbolFacturas.ObtenerFacturasPorServicios(Lista_Ids_Servicios);

            // Pasar la lista de facturas al constructor de la ventana
