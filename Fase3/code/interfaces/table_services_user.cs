...
namespace code.interfaces
{
    public class UserWindowTableServices : Window
    {
            ...
            : base("Servicios")
        {
            ...
            treeViewRecorridos.AppendColumn("Metodo de Pago", new CellRendererText(), "text", 5);

            // Crear el ListStore para almacenar los datos
            listStoreRecorridos = new ListStore(typeof(int), typeof(int), typeof(int), typeof(string), typeof(double), typeof(string));
        ...
        private void MostrarRecorrido(List<Nodo_Servicio> recorrido)
        {
            ...
            {
                listStoreRecorridos.AppendValues(servicio.Id, servicio.Id_Repuesto, servicio.Id_Vehiculo, servicio.Detalles, servicio.Costo, servicio.MetodoPago);
            }
        }
    }
}