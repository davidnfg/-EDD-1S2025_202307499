...
namespace code.structures.tree_binary
{
    ...
    public class Nodo_Servicio
    {
        ...
        public Nodo_Servicio(int id, int idRepuesto, int idVehiculo, string detalles, double costo, string metodoPago)
        {
            Id = id;
    ...
    public class ArbolBinario
    {
        ...
        public void Insertar(int id, int idRepuesto, int idVehiculo, string detalles, double costo, string metodoPago)
        {
            // Creamos un nuevo nodo con los parámetros recibidos
            Nodo_Servicio nuevo = new Nodo_Servicio(id, idRepuesto, idVehiculo, detalles, costo, metodoPago);
